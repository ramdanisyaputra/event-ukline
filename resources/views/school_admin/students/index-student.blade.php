...
<div class="modal fade" id="kelolaStudent" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('superadmin.question-writers.store',$regency->id) }}" method="POST" id="formkelolaStudents">
                @csrf
...
<div class="modal fade" id="editQuestionWriter" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('superadmin.question-writers.update',$regency->id) }}" method="POST" id="formkelolaStudents">
                @csrf
                @method('PUT')
