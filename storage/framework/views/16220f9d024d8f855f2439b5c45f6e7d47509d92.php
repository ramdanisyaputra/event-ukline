...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="<?php echo e(asset('landing/assets_landing_akm/vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('landing/assets_landing_akm/vendor/bootstrap-icons/bootstrap-icons.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('landing/assets_landing_akm/vendor/aos/aos.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('landing/assets_landing_akm/vendor/remixicon/remixicon.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('landing/assets_landing_akm/vendor/swiper/swiper-bundle.min.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('landing/assets_landing_akm/vendor/glightbox/css/glightbox.min.css')); ?>" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="<?php echo e(asset('landing/assets_landing_akm/css/style.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="<?php echo e(route('login')); ?>">Masuk</a></li>
        </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          ...
          <div data-aos="fade-up" data-aos-delay="600">
            <div class="text-center text-lg-start">
              <a href="<?php echo e(route('login')); ?>" class="btn-get-started scrollto d-inline-flex py-4 align-items-center justify-content-center align-self-center">
                <span>Masuk</span>
              </a>
            </div>
          </div>
        ...
        <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
          <img src="<?php echo e(asset('landing/assets_landing_akm/img/hero-img.png')); ?>" class="img-fluid" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
            <img src="<?php echo e(url('landing/assets_landing_akm/img/un1.jpg')); ?>" class="img-fluid" alt="">
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="box" data-aos="fade-up" data-aos-delay="200">
              <img src="<?php echo e(asset('landing/assets_landing_akm/img/values-1.png')); ?>" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box" data-aos="fade-up" data-aos-delay="400">
              <img src="<?php echo e(asset('landing/assets_landing_akm/img/values-2.png')); ?>" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box" data-aos="fade-up" data-aos-delay="600">
              <img src="<?php echo e(asset('landing/assets_landing_akm/img/values-3.png')); ?>" class="img-fluid" alt="">
    ...
    <section id="features" class="features">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <img src="<?php echo e(asset('landing/assets_landing_akm/img/features.png')); ?>" class="img-fluid" alt="">
          </div>
  ...
  <!-- Vendor JS Files -->
  <script src="<?php echo e(asset('landing/assets_landing_akm/vendor/bootstrap/js/bootstrap.bundle.js')); ?>"></script>
  <script src="<?php echo e(asset('landing/assets_landing_akm/vendor/aos/aos.js')); ?>"></script>
  <script src="<?php echo e(asset('landing/assets_landing_akm/vendor/php-email-form/validate.js')); ?>"></script>
  <script src="<?php echo e(asset('landing/assets_landing_akm/vendor/swiper/swiper-bundle.min.js')); ?>"></script>
  <script src="<?php echo e(asset('landing/assets_landing_akm/vendor/purecounter/purecounter.js')); ?>"></script>
  <script src="<?php echo e(asset('landing/assets_landing_akm/vendor/isotope-layout/isotope.pkgd.min.js')); ?>"></script>
  <script src="<?php echo e(asset('landing/assets_landing_akm/vendor/glightbox/js/glightbox.min.js')); ?>"></script>

  <!-- Template Main JS File -->
  <script src="<?php echo e(asset('landing/assets_landing_akm/js/main.js')); ?>"></script>

</body>

</html><?php /**PATH D:\xampp\htdocs\event-ukline\resources\views/welcome.blade.php ENDPATH**/ ?>