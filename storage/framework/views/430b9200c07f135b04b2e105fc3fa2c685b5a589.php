            ...
            <nav class="navbar px-0 d-flex align-items-center py-2 navbar-dark" style="background: #007b88;">
                <div class="container">
                    ...
                    <ul class="navbar-nav d-flex ml-auto mt-2 mt-lg-0">
                        <li class="nav-item">
                            <a class="nav-link font-weight-normal" id="timer"></a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link font-weight-normal" href="#confirmExit" data-toggle="modal" data-target="#confirmExit"><i class="fa fa-sign-out-alt"></i> Keluar</a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="main-content">
                ...
                <div class="container mt-4">
                    <div class="row justify-content-center">
                        <div class="col-md-9">
                            <form action="<?php echo e(route('student.exam.finish', [$exam->id, $token])); ?>" method="POST" id="exam_form">
                                <?php echo csrf_field(); ?>
                                <div id="question-list">
                                    ...
                                    <div class="card border mb-2 bg-whitesmoke question-item" data-key="<?php echo e($key + 1); ?>" data-id="<?php echo e($question->id); ?>" data-type="<?php echo e($question->question_type); ?>">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="question" class="mb-3"><?php echo $question->question; ?></div>
                        ...
                        <div class="col-md-3">
                            <div class="card border mb-3 bg-whitesmoke d-none d-md-block">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-light shadow-none btn-pagination <?php echo e($key == 0 ? 'active' : ''); ?>" data-key="<?php echo e($key); ?>"><?php echo e($key + 1); ?></button>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="confirmExit" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="<?php echo e(route('student.exam.exit', [$exam->id, $token])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="modal-body">
                        Apakah yakin Anda ingin keluar dari ujian ini? <br> <b>Peringatan : </b> semua pekerjaan yang sudah terisi tidak akan tersimpan!
                    </div>
...
<script>
    ...
    var startedAt = "<?php echo e(session()->get('current_exams')[$exam->id]['start_at']); ?>";
    var duration = "<?php echo e($exam->duration); ?>";
    ...
    const countDown = new Date(start.getTime() + duration * 60000);
    ...
    var x = setInterval(() => {
        ...
        if (distance < 0) {
            ...
            document.getElementById('timer').text = `${h < 10 ? '0' : ''}${h}:${m < 10 ? '0' : ''}${m}:${s < 10 ? '0' : ''}${s}`;
        }
    }, 0);
...
</html><?php /**PATH D:\xampp\htdocs\event-ukline\resources\views/student/exam/index.blade.php ENDPATH**/ ?>