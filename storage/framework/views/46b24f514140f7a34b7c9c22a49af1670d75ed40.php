                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-top py-2">
                                    ...
                                    <button class="btn btn-sm btn-danger w-100 mt-2 d-block" data-toggle="modal" data-target="#confirmDelete" data-url="<?php echo e(route('school_admin.exams.questions.delete', [$exam->id, $question->id])); ?>" title="Hapus"><i class="fa fa-trash"></i></button>
                                </td>
                                <?php endif; ?>
                            </tr>
