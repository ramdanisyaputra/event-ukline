<ul class="sidebar-menu">
    ...
    <li class="nav-item {{ request()->is('superadmin/provinces*') ? 'active' : '' }}">
        <a href="{{ route('superadmin.provinces.index') }}" class="nav-link"><i class="fas fa-map"></i><span>Pronvisi</span></a>
    </li>
    ...
    <li class="nav-item {{ request()->is('superadmin/grades*') ? 'active' : '' }}">
        <a href="{{ route('superadmin.index') }}" class="nav-link"><i class="fas fa-align-center"></i><span>Master Kelas</span></a>
    </li>
