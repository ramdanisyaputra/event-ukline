                        ...
                        <div>
                            <table class="w-100">
                                <tr>
                                    ...
                                    <td class="font-weight-bold"><?php echo e(\Carbon\Carbon::parse($exam->started_at)->isoFormat('DD MMMM YYYY, HH:mm')); ?></td>
                                </tr>
                                <tr>
                                    <td class=""><i class="far fa-bell mr-2"></i> Berakhir pada</td>
                                    <td class="font-weight-bold"><?php echo e(\Carbon\Carbon::parse($exam->expired_at)->isoFormat('DD MMMM YYYY, HH:mm')); ?></td>
                                </tr>
                                <tr>
