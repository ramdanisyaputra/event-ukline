                                                    ...
                                                    <div class="option d-flex">
                                                        <div>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="answer{{$key}}{{$ind}}" name="question[{{$key}}][answer]" class="custom-control-input" value="{{ $ind }}" tabindex="-1">
                                                                <label class="custom-control-label cursor-pointer" for="answer{{$key}}{{$ind}}"></label>
                                                            </div>
                                                        </div>
                                                        <div>
                                                            <label class="cursor-pointer" for="answer{{$key}}{{$ind}}">
                                                                {!! $option !!}
                                                            </label>
                                                        </div>
                                                    </div>
    ...
    <div class="modal fade" id="confirmExit" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ route('student.exam.exit', [$exam->id, $token]) }}" method="POST">
                    @csrf
...
<script>
    ...
    var startedAt = "{{ session()->get('current_exams')[$exam->id]['start_at'] }}";
