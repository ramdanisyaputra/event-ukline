...
<section class="section">
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('question_writer.exams.questions.update', [$exam->id, $question->id])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH D:\xampp\htdocs\event-ukline\resources\views/question_writer/exams/questions/edit.blade.php ENDPATH**/ ?>