                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="<?php echo e(route('student.profile.index')); ?>" class="dropdown-item has-icon">
                ...
                <div class="container">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item <?php echo e(request()->is('student/profile') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('student.profile.index')); ?>" class="nav-link"><i class="far fa-user"></i><span>Profil Peserta</span></a>
                        </li>
                    </ul>
                </div>
            </nav>
...
</html><?php /**PATH D:\xampp\htdocs\event-ukline\resources\views/layouts/student.blade.php ENDPATH**/ ?>